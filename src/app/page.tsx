        ...
        <div className="text-center">
          ...
          <div className="bg-white rounded-xl shadow-lg p-8 max-w-4xl mx-auto mb-16">
            <div className="text-center mb-8">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">Área Médica</h3>
              <p className="text-gray-600 mb-8">
                Portal exclusivo para profissionais de saúde. Gerencie consultas, pacientes e histórico médico.
              </p>
              
              <div className="grid md:grid-cols-2 gap-6 max-w-2xl mx-auto">
                <div className="text-center">
                  <h4 className="text-lg font-semibold text-gray-900 mb-3">Novo Médico</h4>
                  <p className="text-gray-600 text-sm mb-4">
                    Cadastre-se na plataforma médica para gerenciar suas consultas.
                  </p>
                  <Link 
                    href="/cadastro-medico"
                    className="inline-block bg-purple-600 hover:bg-purple-700 text-white px-6 py-2 rounded-lg font-medium transition-colors duration-200"
                  >
                    Cadastrar Médico
                  </Link>
                </div>
                ...
                <div className="text-center">
                  <h4 className="text-lg font-semibold text-gray-900 mb-3">Login Médico</h4>
                  <p className="text-gray-600 text-sm mb-4">
                    Acesse sua área médica para gerenciar consultas e pacientes.
                  </p>
                  <Link 
                    href="/login-medico"
                    className="inline-block border border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white px-6 py-2 rounded-lg font-medium transition-colors duration-200"
                  >
                    Acessar Portal
                  </Link>
                </div>
